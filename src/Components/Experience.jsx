...
function Experience() {
  return (
    <div className="experience flex flex-col">
      <h1 className=" heading text-3xl px-10 py-4 md:text-6xl font-league-spartan text-white shadow-content mx-8 my-4 rounded-xl bg-cyan-900 m-8">
        Work Experience
      </h1>
      <div className="companies flex flex-col md:flex-row justity-space-between gap-6 px-10 py-4">
        {workExp.map((exp, index) => (
          <div
            key={index}
            className="content-box flex-1 px-4 py-2 w-full min-h-auto bg-slate-700 rounded-lg  hover:border-4 hover:transition-transform ease-in-out duration-300 hover:border-white hover:scale-105"
          >
